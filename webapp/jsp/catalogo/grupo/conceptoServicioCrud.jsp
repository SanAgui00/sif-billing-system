...
<div class="col-md-10 ml-sm-auto col-lg-10 pb-4">
	<c:if test="${event=='delete'}">
		<sf:form
			action="${pageContext.request.contextPath}/home/cat/grupo/concepto/save"
						...
						<c:forEach items="${consulta}" var="consulta">
							...
							<div class="card-header">
								<span class="title" id="menu-toggle">Eliminar</span> <a
									...
									href="<c:url value='/home/cat/grupo/concepto/'/>" role="button">Regresar</a>
							</div>
								...
								<div class="row">
									<div class="col-sm-12 col-md-12  text-center">
										...
										<a class="btn btn-secondary text-white btn-sm"
											href="<c:url value='/home/cat/grupo/concepto/'/>"
				...
				<div class="row">
					...
					<div class="col-sm-12">
						<div class="card mt-2">
							...
							<div class="card-header">Asignar Servicios</div>
							<div class="collapse show card-body pb-1">
								<div class="row">
									<div class="col-sm-4 col-md-4 mt-2">

										<div class="form-group row">
											<label class="col-sm-4 col-form-label">Buscar
												Servicio</label>
											<div class="col-sm-8">
						...
						<div class="collapse show card-body pb-1">
							<div class="row">
								<div class="col-sm-4 col-md-4 mt-2">
									...
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Buscar Servicio</label>
										<div class="col-sm-8">
											<input type="text" id="list_Servicios"
												class="form-control form-control-sm ajax-form flagServicio"
												placeholder="Busca un Servicio" name="list_Servicios" />

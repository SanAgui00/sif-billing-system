		...
		<div class="col-sm-12">
			<div class="card mt-1">
				<div class="card-header">
					<span class="title" id="menu-toggle">Consulta de Listas
						Clientes</span> <span class="float-right text-secondary" id="btn-ocultar">Ocultar</span>
					<sf:form action="${pageContext.request.contextPath}/home/cat/grupo/listaCliente/crud"
				...
				<sf:form
					action="${pageContext.request.contextPath}/home/cat/grupo/listaCliente"
					method="POST" autocomplete="off">
					<div id="mainMenu" class="collapse show card-body pb-0 pt-0">
						<div class="row">
							<div class="col-sm-6 col-md-6 mt-2">
								<div class="form-group row">
									<label class="col-sm-4 col-form-label">Listas Cliente</label>
									<div class="col-sm-8">
										<select class=" form-control form-control-sm" name="idGrupo"
											id="idGrupo">
											<option value="">Selecciona una opcion</option>
											<c:forEach items="${listaGruposCliente}" var="lista">
							...
							<tbody>
								<c:forEach items="${consulta}" var="consulta">
									<tr>
										...
										<td><sf:form
												action="${pageContext.request.contextPath}/home/cat/grupo/listaCliente/crud"

			...
			<div class="card mt-1">
				<div class="card-header">
					<span class="title" id="menu-toggle">Consulta de Grupos
						Conceptos de Servicios</span> <span class="float-right text-secondary"
						id="btn-ocultar">Ocultar</span>
					<sf:form action="${pageContext.request.contextPath}/home/cat/grupo/concepto/crud"
				...
				<sf:form
					action="${pageContext.request.contextPath}/home/cat/grupo/concepto/"
					method="POST" autocomplete="off">
					<div id="mainMenu" class="collapse show card-body pb-0 pt-0">
						<div class="row">
							<div class="col-sm-6 col-md-6 mt-2">
								<div class="form-group row">
									<label class="col-sm-3 col-form-label">Grupos de
										Conceptos</label>
									<div class="col-sm-9">
							...
							<tbody>
								<c:forEach items="${consulta}" var="consulta">
									<tr>
										...
										<td><sf:form
												action="${pageContext.request.contextPath}/home/cat/grupo/concepto/crud"

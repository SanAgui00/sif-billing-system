...
<div class="col-md-10 ml-sm-auto col-lg-10 pb-4">
	<c:if test="${event=='delete'}">
		<sf:form
			action="${pageContext.request.contextPath}/home/cat/grupo/listaCliente/save"
						...
						<c:forEach items="${consulta}" var="consulta">
							...
							<div class="card-header">
								<span class="title" id="menu-toggle">Eliminar</span> <a
									...
									href="<c:url value='/home/cat/grupo/listaCliente/'/>"
						...
						<div class="card mt-1">
							...
							<div id="mainMenu" class="collapse show card-body pb-0">
								<div class="row">
									...
									<div class="col-sm-6 col-md-6 mt-2">
										<div class="form-group row">
											<label class="col-sm-4 col-form-label">Esquema</label>
											<div class="col-sm-8">
												<select name="esquema" class="form-control form-control-sm"><option
														value="NORMAL"
														${'NORMAL'==consulta.esquema ? 'selected="selected"' : ''}>Grupo
														Normal</option>
													<option value="BENEFICIO"
														${'BENEFICIO'==consulta.esquema ? 'selected="selected"' : ''}>Grupo
														de Beneficio</option></select>
											</div>
										</div>
										<div class="form-group row">
								...
								<table
									...
									<tbody id="tablaAsignacion">
										<c:forEach items="${consultaAsignar}" var="lista">
											<tr>
												<td class="getColumn"><c:out
														value="${lista.clave_cliente}"></c:out></td>
												<td><c:out value="${lista.nombre_corto}"></c:out></td>
												<td><c:out value="${lista.b_beneficiario}"></c:out></td>
												<td><input type="text" name="distribucion"
													class="getDistribucion" id="${lista.id_cliente}"
													value="<c:out value="${lista.distribucion}"></c:out>"></td>
												<td><fmt:formatDate value="${lista.fecha_crea}"
														pattern="dd/MM/yyyy" /></td>
												<td><div class="form-check">
														<input
															class="form-check-input form-check-input-beneficiario position-static"
															type="checkbox" value="${lista.id_cliente}"
															${lista.b_beneficiario eq 'Si' ? 'checked="checked"':''} />
													</div></td>
												<td><div class="form-check">
														<input
										...
										<input type="hidden" name="listaBeneficiarios"
											id="listaBeneficiarios" />
										<input type="hidden" name="listaDistribucion"
										...
										<div class="form-group row">
											<div class="col-md-6">
												<button type="button"
													...
													id="btnAsignarLista">Asignar</button>
											</div>
											<div class="col-md-6">
												<button type="button"
													class="btn btn-secondary text-white btn-sm float-right mb-1 mt-auto"
							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-6 mt-2">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<select name="esquema" class="form-control form-control-sm"><option
													value="NORMAL" class="texto">Grupo Normal</option>
												<option value="BENEFICIO" class="texto">Grupo de
													Beneficio</option></select>
										</div>
									</div>

			...
			<div class="card mt-1">
				<div class="card-header">
					<span class="title" id="menu-toggle">Consulta de Grupos
						Volumen de Servicios</span> <span class="float-right text-secondary"
						id="btn-ocultar">Ocultar</span>
					<sf:form action="${pageContext.request.contextPath}/home/cat/grupo/volumenServicio/crud"
				...
				<sf:form
					action="${pageContext.request.contextPath}/home/cat/grupo/volumenServicio"
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<select class=" form-control form-control-sm" name="idGrupo"
											...
											<c:forEach items="${listaGrupoVolumenServicio}" var="lista">
							...
							<tbody>
								<c:forEach items="${consulta}" var="consulta">
									<tr>
										...
										<td><sf:form
												action="${pageContext.request.contextPath}/home/cat/grupo/volumenServicio/crud"

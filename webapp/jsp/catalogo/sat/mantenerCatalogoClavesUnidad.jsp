		...
		<div class="col-sm-12">
			<div class="card mt-1">				
					<div class="card-header">
						<span class="title" id="menu-toggle">Mantener Catalogo de Claves de Unidad</span> <span class="float-right text-secondary"
							id="btn-ocultar">Ocultar</span>
						<sf:form
						action="${pageContext.request.contextPath}/home/cat/sat/unidad/crud"
				...
				<sf:form
					action="${pageContext.request.contextPath}/home/cat/sat/unidad"
						...
						<div class="row">
							<div class="col-sm-6 col-md-6 mt-2 mb-2">
								...
								<div class="form-group row">
									<label class="col-sm-4 col-form-label">Formas de Pago</label>
									<div class="col-sm-8">
						...
						<tbody>
							<c:forEach items="${consulta}" var="lista">
								<tr>
									...
									<td><sf:form action="${pageContext.request.contextPath}/home/cat/sat/unidad/crud"

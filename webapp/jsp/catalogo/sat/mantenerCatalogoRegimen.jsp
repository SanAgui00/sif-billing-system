		...
		<div class="col-sm-12">
			<div class="card mt-1">
					...
					<div class="card-header">
						<span class="title" id="menu-toggle">Mantener Catalogo de Regimen Fiscal</span> <span class="float-right text-secondary"
							id="btn-ocultar">Ocultar</span>
						<sf:form
						action="${pageContext.request.contextPath}/home/cat/sat/regimen/crud"
				...
				<sf:form
					action="${pageContext.request.contextPath}/home/cat/sat/regimen"
									...
									<div class="col-sm-8">
										<select class="ajax-form-negocio form-control form-control-sm"
											...
											<c:forEach items="${listaRegimenFiscal}" var="lista">
												...
												${lista.id eq regimen ? 'selected="selected"' : ''}>

...
# Descripcion General : Vista JSP para  Crud Catalógo SAT 					   # 
		...
		<div class="card">
			<div class="form-row h-100">
				...
				<div class="form-group auto col-sm-12 the-title">
						<sf:form
							action="${pageContext.request.contextPath}/home/cat/sat/comprobantes/save"
							method="POST" name="insert">
							<c:forEach items="${editar}" var="editar">
								<input name="evento" type="hidden" value="delete" />
								<input name="idComprobantes" type="hidden" value="${editar.id}" />
								<div class="card-header">
									<span class="title" id="menu-toggle">Eliminar</span> <a
										class="float-right text-secondary"
										href="<c:url value='/home/cat/sat/comprobantes'/>" role="button">Regresar</a>
								</div>
									...
									<div class="row">
										<div class="col-sm-12 col-md-12  text-center">
											...
											<a class="btn btn-secondary text-white btn-sm"
												href="<c:url value='/home/cat/sat/comprobantes'/>"
								...
								<div id="mainMenu" class="show card card-body">
									...
									<div class="row">
										<div class="col-sm-6 col-md-6 mt-2 mb-2">
											...
											<div class="form-group row">
												<label class="col-sm-4 col-form-label">Valor Minimo</label>
												<div class="col-sm-8">
													<input type="text" class="form-control form-control-sm"
														name="minimo" value="${editar.valor_minimo}">
												</div>
											</div>
											<div class="form-group row">
										...
										<div class="col-sm-6 col-md-6 mt-2 mb-2">
											...
											<div class="form-group row">
												<label class="col-sm-4 col-form-label">Valor Maximo</label>
												<div class="col-sm-8">
													<input type="text" class="form-control form-control-sm"
														name="maximo" value="${editar.valor_maximo}">
												</div>
											</div>
											<div class="form-group row">

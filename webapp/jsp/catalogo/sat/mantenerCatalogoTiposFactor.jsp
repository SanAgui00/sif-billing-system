		...
		<div class="col-sm-12">
			<div class="card mt-1">
					...
					<div class="card-header">
						<span class="title" id="menu-toggle">Catálogo Tipos de factor</span> <span class="float-right text-secondary"
							id="btn-ocultar">Ocultar</span>
						<sf:form
						action="${pageContext.request.contextPath}/home/cat/sat/factor/crud"
				...
				<sf:form
					action="${pageContext.request.contextPath}/home/cat/sat/factor"
						...
						<div class="row">
							<div class="col-sm-6 col-md-6 mt-2 mb-2">
								...
								<div class="form-group row">
									<label class="col-sm-4 col-form-label"> Tipo de factor</label>
									<div class="col-sm-8">
										<select class="ajax-form-negocio form-control form-control-sm"
											name="factor" id="factor">
											<option value="">Selecciona una opcion</option>
											<c:forEach items="${listaTiposFactor}" var="fuente">
						<option value="${fuente.id}" ${fuente.id eq factor ? 'selected="selected"' : ''}>
		...
		<c:if test="${not empty consulta}">
			...
			<c:if test="${not empty registros_totales}">
				<sf:form
					...
					<input type="hidden" name="regimen" id="getregimen"
						class="globalGet">

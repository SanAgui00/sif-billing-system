									...
									<div class="row">
										<div class="col-sm-12 col-md-12  text-center">
											...
											<a class="btn btn-secondary text-white btn-sm"
												href="<c:url value='/home/cat/sat/formaspago'/>"
								...
								<div id="mainMenu" class="show card card-body">
									...
									<div class="row">
										<div class="col-sm-6 col-md-6 mt-2 mb-2">
											...
											<div class="form-group row">
												<label class="col-sm-4 col-form-label">Bancarizado</label>
												<div class="col-sm-8">
													<select class="form-control form-control-sm" name="bancarizado">
														<option value="Si"
															${ 'Si'==editar.bancarizado ? 'selected="selected"' : ''}>Si</option>
														<option value="No"
															${ 'No'==editar.bancarizado ? 'selected="selected"' : ''}>No</option>
													</select>
												</div>
											</div>
											<div class="form-group row">
				...
				<div class="form-row h-100">
					<div class="form-group auto col-sm-12 the-title">
						<sf:form
							...
							<div class="card-header">
								<span class="title" id="menu-toggle">Nueva Forma de Pago</span> <a
									class="float-right text-secondary"
									href="<c:url value='/home/cat/sat/formaspago'/>" role="button">Regresar</a>
							</div>
							<div id="mainMenu" class="show card card-body">

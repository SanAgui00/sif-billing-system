		...
		<div class="col-sm-12">
			<div class="card mt-1">
					...
					<div class="card-header">
						<span class="title" id="menu-toggle">Mantener Catalogo Tipos de Comprobantes</span> <span class="float-right text-secondary"
							id="btn-ocultar">Ocultar</span>
						<sf:form
						action="${pageContext.request.contextPath}/home/cat/sat/comprobantes/crud"
				...
				<sf:form
					action="${pageContext.request.contextPath}/home/cat/sat/comprobantes"
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<select class="ajax-form-negocio form-control form-control-sm"
											name="comprobante" id="comprobante">
											<option value="">Selecciona una opcion</option>
											<c:forEach items="${listaTiposComprobante}" var="lista">
												<option value="${lista.id}"
												${lista.id eq comprobante ? 'selected="selected"' : ''}>
		...
		<c:if test="${not empty consulta}">
						...
						<tbody>
							<c:forEach items="${consulta}" var="lista">
								<tr>
									...
									<td>${lista.valor_minimo}</td>
									<td>${lista.valor_maximo}</td>
									<td>${lista.estatus}</td>
			...
			<c:if test="${not empty registros_totales}">
				<sf:form
					...
					<input type="hidden" name="comprobante" id="getcomprobante"
						class="globalGet">

									...
									<div class="row">
										<div class="col-sm-12 col-md-12  text-center">
											...
											<a class="btn btn-secondary text-white btn-sm"
												href="<c:url value='/home/cat/sat/impuesto'/>"
								...
								<div id="mainMenu" class="show card card-body">
									...
									<div class="row">
										<div class="col-sm-6 col-md-6 mt-2 mb-2">
											...
											<div class="form-group row">
												<label class="col-sm-4 col-form-label">Aplica Traslado</label>
												<div class="col-sm-8">
													<select class="form-control form-control-sm" name="tras">
														<option value="Si"
															${ 'Si'==editar.traslado ? 'selected="selected"' : ''}>Si</option>
														<option value="No"
															${ 'No'==editar.traslado ? 'selected="selected"' : ''}>No</option>
													</select>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="form-group row">
												<label class="col-sm-4 col-form-label">Tipo entidad</label>
												<div class="col-sm-8">
													<select class="form-control form-control-sm" name="Tipoentidad">
														<option value="Federal"
															${ 'Federal'==editar.tipo_entidad ? 'selected="selected"' : ''}>Federal</option>
														<option value="Local"
															${ 'Local'==editar.tipo_entidad ? 'selected="selected"' : ''}>Local</option>
													</select>
												</div>
											</div>
										...
										<div class="col-sm-6 col-md-6 mt-2 mb-2">
											...
											<div class="form-group row">
												<label class="col-sm-4 col-form-label">Aplica Retencion</label>
												<div class="col-sm-8">
													<select class="form-control form-control-sm" name="reten">
														<option value="Si"
															${ 'Si'==editar.retencion ? 'selected="selected"' : ''}>Si</option>
														<option value="No"
															${ 'No'==editar.retencion ? 'selected="selected"' : ''}>No</option>
													</select>
												</div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control form-control-sm"
														name="entidad" value="${editar.nombre_entidad}">
												</div>
											</div>
											<div class="form-group row">
				...
				<div class="form-row h-100">
					<div class="form-group auto col-sm-12 the-title">
						<sf:form
							...
							<div class="card-header">
								<span class="title" id="menu-toggle">Nuevo Tipo impuesto</span> <a
									class="float-right text-secondary"
									href="<c:url value='/home/cat/sat/impuesto'/>" role="button">Regresar</a>
							</div>
							<div id="mainMenu" class="show card card-body">
								<div class="row">
									<div class="col-sm-6 col-md-6 mt-2 mb-2">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<select class="form-control form-control-sm" name="Tipoentidad">
													<option value="federa">Federal</option>

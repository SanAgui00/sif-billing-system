		...
		<div class="col-sm-12">
			<div class="card mt-1">				
					<div class="card-header">
						<span class="title" id="menu-toggle">Mantener Catalogo de Claves de Servicios/Productos</span> <span class="float-right text-secondary"
							id="btn-ocultar">Ocultar</span>
						<sf:form
						action="${pageContext.request.contextPath}/home/cat/sat/servicio/crud"
						...
						<button type="submit"
							...
							Claves de Servicios/Producto</button>
					</sf:form>
					</div>
				<sf:form
					action="${pageContext.request.contextPath}/home/cat/sat/servicio"
						...
						<div class="row">
							<div class="col-sm-6 col-md-6 mt-2 mb-2">
								...
								<div class="form-group row">
									<label class="col-sm-4 col-form-label">Clave de servicio</label>
									<div class="col-sm-8">
						...
						<tbody>
							<c:forEach items="${consulta}" var="lista">
								<tr>
									...
									<td>${lista.iva_traslado}</td>
									<td>${lista.ieps_traslado}</td>
									<td>${lista.estatus}</td>
									<td><fmt:formatDate value="${lista.fecha}" pattern="dd-MM-yyyy HH:mm:ss" /></td>
									<td><sf:form action="${pageContext.request.contextPath}/home/cat/sat/servicio/crud"

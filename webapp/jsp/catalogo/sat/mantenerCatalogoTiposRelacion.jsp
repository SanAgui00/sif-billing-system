		...
		<div class="col-sm-12">
			<div class="card mt-1">				
					<div class="card-header">
						<span class="title" id="menu-toggle">Mantener Catalogo de Tipos Relacion</span> <span class="float-right text-secondary"
							id="btn-ocultar">Ocultar</span>
						<sf:form
						action="${pageContext.request.contextPath}/home/cat/sat/relacion/crud"
						...
						<button type="submit"
							...
							Tipo Relacion</button>
					</sf:form>
					</div>
				<sf:form
					action="${pageContext.request.contextPath}/home/cat/sat/relacion"
						...
						<div class="row">
							<div class="col-sm-6 col-md-6 mt-2 mb-2">
								...
								<div class="form-group row">
									<label class="col-sm-4 col-form-label">Tipos Relacion</label>
									<div class="col-sm-8">
										<select class="ajax-form-negocio form-control form-control-sm"
											name="metodos" id="metodos">
											<option value="">Selecciona una opcion</option>
											<c:forEach items="${listaTipoRelacion}" var="lista">
						...
						<tbody>
							<c:forEach items="${consulta}" var="lista">
								<tr>
									...
									<td><sf:form action="${pageContext.request.contextPath}/home/cat/sat/relacion/crud"

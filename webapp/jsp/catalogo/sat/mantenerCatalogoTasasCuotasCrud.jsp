		...
		<div class="card">
			<div class="form-row h-100">
				...
				<div class="form-group auto col-sm-12 the-title">
						...
						<sf:form
							action="${pageContext.request.contextPath}/home/cat/sat/tasascuota/save"
							method="POST" name="insert">
							<c:forEach items="${editar}" var="editar">
								<input name="evento" type="hidden" value="delete" />
								<input name="idtasascuota" type="hidden" value="${editar.id}" />
								<div class="card-header">
									<span class="title" id="menu-toggle">Eliminar</span> <a
										class="float-right text-secondary"
										href="<c:url value='/home/cat/sat/tasascuota'/>" role="button">Regresar</a>
								</div>
									...
									<div class="row">
										<div class="col-sm-12 col-md-12  text-center">
											...
											<a class="btn btn-secondary text-white btn-sm"
												href="<c:url value='/home/cat/sat/tasascuota'/>"
									...
									<div class="row">
										<div class="col-sm-6 col-md-6 mt-2 mb-2">
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control form-control-sm"
														name="valorminimo" value="${editar.valor_minimo}">
												</div>
											</div>
										...
										<div class="col-sm-6 col-md-6 mt-2 mb-2">
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control form-control-sm"
														name="valormaximo" value="${editar.valor_maximo}">
												</div>
											</div>

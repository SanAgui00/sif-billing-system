		...
		<div class="card-body">
			<div class="form-row h-100">
				...
				<div class="form-group col-md-6 auto">
					<c:if test="${event=='delete'}">
						<sf:form action="${pageContext.request.contextPath}/home/cat/apoyo/umedida/save" method="POST" name="insert">
							<c:forEach items="${consulta}" var="consulta">
					...
					<a class="btn btn-secondary text-white btn-sm float-right " href="<c:url value='/home/cat/apoyo/umedida'/>" role="button">Regresar</a>
				</div>
			</div>
		</div>
	</div>

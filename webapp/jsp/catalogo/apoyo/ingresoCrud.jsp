		...
		<div class="card-body">
			<div class="form-row h-100">
				...
				<div class="form-group col-md-6 auto">
					<c:if test="${event=='delete'}">
						<sf:form action="${pageContext.request.contextPath}/home/cat/apoyo/categorias/save" method="POST" name="insert">
							<c:forEach items="${consulta}" var="consulta">
					...
					<a class="btn btn-secondary text-white btn-sm float-right " href="<c:url value='/home/cat/apoyo/categorias'/>" role="button">Regresar</a>
				</div>
			</div>
		</div>
	</div>
								...
								<div class="form-row">
									<div class="col-md-6">
										<div class="input-group input-group-sm mb-3">
											...
											<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="clave" value="${consulta.clave}" maxlength="8">
										</div>
									</div>
									<div class="col-md-6">
										<div class="input-group input-group-sm mb-3">
							...
							<div class="form-row">
								<div class="col-md-6">
									<div class="input-group input-group-sm mb-3">
										...
										<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="clave" maxlength="8">
									</div>
								</div>
								<div class="col-md-6">
									<div class="input-group input-group-sm mb-3">

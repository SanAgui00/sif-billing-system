		...
		<div class="card-body">
			<div class="form-row h-100">
				...
				<div class="form-group col-md-6 auto">
					<c:if test="${event=='delete'}">
						<sf:form
							action="${pageContext.request.contextPath}/home/cat/apoyo/parametros/save"
					...
					<a class="btn btn-secondary text-white btn-sm float-right "
						href="<c:url value='/home/cat/apoyo/parametros'/>" role="button">Regresar</a>
				</div>
			</div>
		</div>
	</div>
	<c:if test="${event=='edit' && not empty consulta}">
		<sf:form
			...
			<c:forEach items="${consulta}" var="consulta">
				...
				<input name="id" type="hidden" value="${consulta.id}" />
				<input name="id_funcionalidad" type="hidden"
					value="${consulta.id_funcionalidad}" />
							...
							<div class="card-body">
								<div class="form-row">
									...
									<div class="col-md-6">
										<div class="input-group input-group-sm mb-3">
											<div class="input-group-prepend">
												<span class="input-group-text" id="inputGroup-sizing-sm">Valor
													1</span>
											</div>
											<input type="text" class="form-control" aria-label="Small"
												aria-describedby="inputGroup-sizing-sm" name="valor1"
												value="${consulta.valor1}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="input-group input-group-sm mb-3">
											...
											<input type="text" class="form-control" aria-label="Small"
												aria-describedby="inputGroup-sizing-sm" name="valor2"
												value="${consulta.valor2}">
										</div>
									</div>
									<div class="col-md-4">
										<select class="form-control form-control-sm" name="estatus"
											...
											<option value="ACT"
												${'ACT' eq consulta.estatus ? 'selected="selected"':''}>Activo</option>
											<option value="ELI"
												${'ELI' eq consulta.estatus ? 'selected="selected"':''}>Eliminado</option>
										</select>
									...
									<div class="col-md-4">
										<div class="input-group input-group-sm mb-3">
											<div class="input-group-prepend">
												<span class="input-group-text" id="inputGroup-sizing-sm">Autor
													últ. mod.</span>
											</div>
											<input type="text" class="form-control" aria-label="Small"
												aria-describedby="inputGroup-sizing-sm" name="usuario"
												value="${consulta.usuario}" disabled>
										</div>
									</div>
									<div class="col-md-4">
										<div class="input-group input-group-sm mb-3">
											...
											<input type="date" class="form-control form-control-sm"
												name="fecha_crea"
												value="<fmt:formatDate value="${consulta.fecha}" pattern="yyyy-MM-dd"/>"
												disabled />
										</div>
									</div>
									<div class="col-md-12">
							...
							<div class="form-row">
								...
								<div class="col-md-4">
									<div class="input-group input-group-sm mb-3">
										...
										<input type="text" class="form-control" aria-label="Small"
											aria-describedby="inputGroup-sizing-sm" name="estatus"
											value="ACT">
									</div>
								</div>

		...
		<div class="card-body">
			<div class="form-row h-100">
				...
				<div class="form-group col-md-6 auto">
					<c:if test="${event=='delete'}">
						<sf:form action="${pageContext.request.contextPath}/home/cat/apoyo/centrocostos/save" method="POST" name="insert">
							<c:forEach items="${consulta}" var="consulta">
								<input name="evento" type="hidden" value="delete" />
								<input name="id_centro_costos" type="hidden" value="${consulta.id_centro_costos}" />
								<button type="submit" class="btn btn-secondary text-white btn-sm float-right ">Eliminar</button>
							</c:forEach>
						</sf:form>
					</c:if>
					<a class="btn btn-secondary text-white btn-sm float-right " href="<c:url value='/home/cat/apoyo/centrocostos'/>" role="button">Regresar</a>
				</div>
			</div>
		</div>
	</div>
								...
								<div class="form-row">
									<div class="col-md-4">
										<div class="input-group input-group-sm mb-3">
											...
											<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="${consulta.clave_centro_costos}" name="clave_centro_costos">
										</div>
									</div>
									<div class="col-md-8">
										<div class="input-group input-group-sm mb-3">
							...
							<div class="form-row">
								<div class="col-md-4">
									<div class="input-group input-group-sm mb-3">
										...
										<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="clave_centro_costos">
									</div>
								</div>
								<div class="col-md-8">
									<div class="input-group input-group-sm mb-3">

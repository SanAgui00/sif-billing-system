...
<%-- # Proyecto/Procliente : Vista de crud de redes logicas       Fecha: 08/03/2018 # --%>
<%-- # Descripcion General : 									   	                # --%>
<%-- # Marca del cambio    : 									                    # --%>
<%-- ################################################################################ --%>
									...
									<div class="row">
										<div class="col-sm-12 col-md-12  text-center">
											...
											<a class="btn btn-secondary text-white btn-sm"
												href="<c:url value='/home/cat/estructuraDatos'/>"
									...
									<div class="row">
										...
										<div class="col-sm-6 col-md-6 mt-2 mb-2">
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control form-control-sm"
														name="usuario" value="${editar.usuario}">
												</div>
											</div>
											<div class="form-group row">
				...
				<div class="form-row h-100">
					<div class="form-group auto col-sm-12 the-title">
						<sf:form
							...
							<div class="card-header">
								<span class="title">Nueva Red Logica</span> <a
									class="float-right text-secondary"
									href="<c:url value='/home/cat/redes/'/>" role="button">Regresar</a>
							</div>
							<div id="mainMenu" class="show card card-body">

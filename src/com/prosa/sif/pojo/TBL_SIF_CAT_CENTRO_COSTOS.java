...
# Descripcion General : Pojo para mapeo de TBL_SIF_CAT_CENTRO_COSTOS           #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TBL_SIF_CAT_CENTRO_COSTOS {
	@Id
	...
	public TBL_SIF_CAT_CENTRO_COSTOS() {

	}

	public TBL_SIF_CAT_CENTRO_COSTOS(Integer id_centro_costos, String clave_centro_costos, String descripcion,
	...
	public String toString() {
		return "TBL_SIF_CAT_CENTRO_COSTOS [id_centro_costos=" + id_centro_costos + ", clave_centro_costos="
				+ clave_centro_costos + ", descripcion=" + descripcion + ", estatus=" + estatus + ", fecha_cre="

...
public class VIEW_REPORTE_CUENTAS_ACTIVAS {
	...
	public VIEW_REPORTE_CUENTAS_ACTIVAS() {

	}

	public VIEW_REPORTE_CUENTAS_ACTIVAS(Integer id_vista, BigDecimal trans_debito, BigDecimal cuota_fija,
			BigDecimal precio_debito, BigDecimal precio_credito, BigDecimal trans_credito, BigDecimal total,
			BigDecimal importe_credito, BigDecimal importe_debito, Integer id_moneda, Integer id_periodo,

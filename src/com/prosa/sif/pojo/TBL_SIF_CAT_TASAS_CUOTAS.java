...
public class TBL_SIF_CAT_TASAS_CUOTAS {
	...
	public TBL_SIF_CAT_TASAS_CUOTAS() {
		
	}

	public TBL_SIF_CAT_TASAS_CUOTAS(Integer id, String clave, String descripcion, Integer valor_minimo,
	...
	public String toString() {
		return "TBL_SIF_CAT_TASAS_CUOTAS [id=" + id + ", clave=" + clave + ", descripcion=" + descripcion

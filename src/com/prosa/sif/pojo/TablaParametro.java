...
# Descripcion General : Pojo para mapeo de TablaParametro              #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TablaParametro {
	...
	public TablaParametro(Integer id, String nombre, String estatus, String valor1, String valor2, String usuario,
			Date fecha, Integer id_funcionalidad) {
		super();
		this.id = id;
		this.nombre = nombre;
	...
	public String toString() {
		return "TablaParametro [id=" + id + ", nombre=" + nombre + ", estatus=" + estatus + ", valor1=" + valor1

...
@Entity
@Table(name = "VIEW_COBRANZA_DIARIA_TABLA_DOS")
public class ViewCobranzaDiariaDos {
	...
	public ViewCobranzaDiariaDos() {

	}

	public ViewCobranzaDiariaDos(BigDecimal id_vista, BigDecimal id_negocio, BigDecimal total_trx_cobdia,
			BigDecimal total_imp_cobdia, BigDecimal total_imp_ajuste, BigDecimal total_desc_especial,
			BigDecimal total_desc_adicional, String clave_negocio, String descripcion_negocio) {
		super();
	...
	public String toString() {
		return "VIEW_COBRANZA_DIARIA_TABLA_DOS [id_vista=" + id_vista + ", id_negocio=" + id_negocio
				...
				+ ", total_desc_adicional=" + total_desc_adicional + ", clave_negocio=" + clave_negocio

...
# Descripcion General : Pojo para mapeo de TablaCatProcesos                    #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
@Entity
@Table(name = "TBL_SIF_CAT_PROCESOS")
public class TablaProceso {
	...
	public TablaProceso(Integer id_proceso, Integer id_empresa, String clave_proceso, String descripcion,
	...
	public String toString() {
		return "TablaProceso [id_proceso=" + id_proceso + ", id_empresa=" + id_empresa + ", clave_proceso="

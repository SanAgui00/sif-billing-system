...
public class ViewReporteFolio {
	...
	public ViewReporteFolio() {

	}

	public ViewReporteFolio(BigDecimal numero, Integer id_moneda, Integer id_proceso, Integer id_negocio,
			String folio, Integer id_empresa, String tipo_documento, String clave_proceso, String descripcion_proceso,
			String clave, String descripcion_negocio, String rfc, String clave_cliente, String razon_social,
			String nombre_corto, String direccion_cliente, String nombre_moneda, BigDecimal subtotal_monto,
			BigDecimal importe_iva, BigDecimal total, BigDecimal tipo_cambio, Date fecha_reservacion,
			Date fecha_ult_impresion, Date fecha_ult_modific, String estatus, String comentarios,
			String concepto_descripcion, Date fecha_datos, String serie, BigDecimal descuento, String clave_documento,
			BigDecimal porc_iva_cliente, Integer id_vista) {
		super();
		this.numero = numero;
	...
	public String toString() {
		return "VIEW_REPORTE_FOLIOS [numero=" + numero + ", id_moneda=" + id_moneda + ", id_proceso=" + id_proceso
				+ ", id_negocio=" + id_negocio + ", folio=" + folio + ", id_empresa=" + id_empresa + ", tipo_documento="
				+ tipo_documento + ", clave_proceso=" + clave_proceso + ", descripcion_proceso=" + descripcion_proceso
				+ ", clave=" + clave + ", descripcion_negocio=" + descripcion_negocio + ", rfc=" + rfc
				+ ", clave_cliente=" + clave_cliente + ", razon_social=" + razon_social + ", nombre_corto="
				+ nombre_corto + ", direccion_cliente=" + direccion_cliente + ", nombre_moneda=" + nombre_moneda
				+ ", subtotal_monto=" + subtotal_monto + ", importe_iva=" + importe_iva + ", total=" + total
				+ ", tipo_cambio=" + tipo_cambio + ", fecha_reservacion=" + fecha_reservacion + ", fecha_ult_impresion="
				+ fecha_ult_impresion + ", fecha_ult_modific=" + fecha_ult_modific + ", estatus=" + estatus
				+ ", comentarios=" + comentarios + ", concepto_descripcion=" + concepto_descripcion + ", fecha_datos="
				+ fecha_datos + ", serie=" + serie + ", descuento=" + descuento + ", clave_documento=" + clave_documento
				+ ", porc_iva_cliente=" + porc_iva_cliente + ", id_vista=" + id_vista + "]";
	}

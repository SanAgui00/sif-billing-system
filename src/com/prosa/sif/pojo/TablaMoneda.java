...
# Descripcion General : Pojo para mapeo de TablaMoneda                 #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TablaMoneda {
	...
	public TablaMoneda(Integer id_moneda, String nombre_moneda, String pais, String simbolo, BigDecimal t_moneda,
			String estatus, Date fecha_cre, Date fecha_mod, String usuario, String comentarios, String clave_sat,
			String nombre_sat, BigDecimal decimales, BigDecimal variacion) {
		super();
	...
	public String toString() {
		return "TablaMoneda [id_moneda=" + id_moneda + ", nombre_moneda=" + nombre_moneda + ", pais=" + pais

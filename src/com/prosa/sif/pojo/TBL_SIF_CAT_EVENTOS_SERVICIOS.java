...
# Descripcion General : Pojo para mapeo de TBL_SIF_CAT_EVENTOS_SERVICIOS       #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TBL_SIF_CAT_EVENTOS_SERVICIOS {
	@Id
	private Integer id;
	...
	private TBL_SIF_SERVICIOS tbl_sif_servicios;

	public TBL_SIF_CAT_EVENTOS_SERVICIOS() {
	}

	public TBL_SIF_CAT_EVENTOS_SERVICIOS(String codigo, String clave, Integer id_servicios, String descripcion,
			String b_adq_emi, String origen, String estatus, String usuario, Date fecha,
			TBL_SIF_SERVICIOS tbl_sif_servicios) {
		super();
		this.codigo = codigo;
		this.clave = clave;
	...
	public TBL_SIF_SERVICIOS getTbl_sif_servicios() {
		return tbl_sif_servicios;
	}

	public void setTbl_sif_servicios(TBL_SIF_SERVICIOS tbl_sif_servicios) {
		this.tbl_sif_servicios = tbl_sif_servicios;
	}

	@Override
	public String toString() {
		return "TBL_SIF_CAT_EVENTOS_SERVICIOS [id=" + id + ",id_servicios=" + id_servicios + ",codigo=" + codigo

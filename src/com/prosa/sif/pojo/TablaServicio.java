...
# Proyecto/Procliente :                                      Fecha: 22/05/2018 #
# Descripcion General : Pojo para mapeo de TablaServicios                      #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TablaServicio {
	...
	public TablaServicio(Integer id_servicios, Integer id_fuente, Integer id_negocio, Integer id_precio,
	...
	public String toString() {
		return "TablaServicio [id_servicios=" + id_servicios + ", id_fuente=" + id_fuente + ", id_negocio=" + id_negocio
				+ ", id_precio=" + id_precio + ", id_forma_pago=" + id_forma_pago + ", id_grupo_vol=" + id_grupo_vol
				...
				+ ", descripcion=" + descripcion + ", estatus=" + estatus + ", b_adquisicion_auto=" + b_adquisicion_auto
				+ ", periodicidad_adquisicion=" + periodicidad_adquisicion + ", periodicidad_cobro="
				+ periodicidad_cobro + ", dias_habiles_cobro=" + dias_habiles_cobro + ", dia_limite_solicitud="
				+ dia_limite_solicitud + ", b_habilitar_op_av=" + b_habilitar_op_av + ", realizar_envio="
				+ realizar_envio + ", realizar_reg_cont=" + realizar_reg_cont + ", realizar_emision_fact="
				+ realizar_emision_fact + ", b_auto_cobro=" + b_auto_cobro + ", b_auto_reg_cont=" + b_auto_reg_cont
				+ ", b_incluir_rebate=" + b_incluir_rebate + ", unidad_medida=" + unidad_medida + ", tipo_cargo="
				+ tipo_cargo + ", sistem_cobro=" + sistem_cobro + ", b_captura_imp_liquidado=" + b_captura_imp_liquidado
				+ ", b_precio_controlado=" + b_precio_controlado + ", b_adquisicion_sin_iva=" + b_adquisicion_sin_iva

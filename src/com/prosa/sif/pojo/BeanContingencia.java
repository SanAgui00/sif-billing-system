...
public class BeanContingencia {
	...
	public BeanContingencia() {

	}

	public BeanContingencia(Number id_fuente, Date hora_inicio, Date hora_final, String descripcion_evento,
	...
	public String toString() {
		return "BeanContingencia [id_fuente=" + id_fuente + ", hora_inicio=" + hora_inicio + ", hora_final="

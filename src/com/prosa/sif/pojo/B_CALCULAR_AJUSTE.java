...
public class B_CALCULAR_AJUSTE {
	...
	public B_CALCULAR_AJUSTE() {

	}

	public B_CALCULAR_AJUSTE(Number id_fuente, String clave, String estatus, Date fecha_datos, Number id_proceso,
	...
	public String toString() {
		return "B_CALCULAR_AJUSTE [id_fuente=" + id_fuente + ", clave=" + clave + ", estatus=" + estatus

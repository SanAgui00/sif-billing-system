...
# Descripcion General : Pojo para mapeo de TablaReglasCarga                    #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TablaReglaCarga {
	...
	public TablaReglaCarga() {
	}

	public TablaReglaCarga(Integer id_reglas_carga, Integer id_fuente, String usuario, String estatus,
	...
	public String toString() {
		return "TablaReglaCarga [id_reglas_carga=" + id_reglas_carga + ", id_fuente=" + id_fuente + ", usuario="

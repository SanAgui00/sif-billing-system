...
# Proyecto/Procliente :                                      Fecha: 03/08/2018 #
# Descripcion General : Pojo para mapeo de TablaGpoVolServ                     #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TablaGrupoVolumenServicio {
	@Id
	...
	public TablaGrupoVolumenServicio() {

	}

	public TablaGrupoVolumenServicio(Integer id_grupo, String clave, String descripcion, String estatus,
	...
	public String toString() {
		return "TablaGrupoVolumenServicio [id_grupo=" + id_grupo + ", clave=" + clave + ", descripcion=" + descripcion

...
# Descripcion General : Pojo para mapeo de TBL_SIF_CAT_NEGOCIOS                #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TBL_SIF_CAT_NEGOCIOS {
	@Id
	...
	public TBL_SIF_CAT_NEGOCIOS() {
	}

	public TBL_SIF_CAT_NEGOCIOS(Integer id_negocio, Integer id_proceso, Integer id_centro_costos,
			Integer id_negocio_padre, Integer id_grupo_edo_cuenta, String clave, String descripcion,
			String cuenta_ingreso, String clave_gl, String usuario, String status, Date fecha_cre, Date fecha_mod,
			String comentarios, String concepto_carta, String clave_metodopago_sat, String clave_usocfdi_sat) {
		super();
	...
	public String toString() {
		return "TBL_SIF_CAT_NEGOCIOS [id_negocio=" + id_negocio + ", id_proceso=" + id_proceso + ", id_centro_costos="

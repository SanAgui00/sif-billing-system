...
public class TBL_SIF_ESTRUCTURA_DATOS_FTE {
	@Id
	...
	public TBL_SIF_ESTRUCTURA_DATOS_FTE() {

	}

	public TBL_SIF_ESTRUCTURA_DATOS_FTE(Integer id_estructura, Integer id_fuente, String tabla_totales,
			String tabla_temporal, Integer b_suspender_depuracion, Integer b_no_hay_carga, String nombre_campo_cliente,
	...
	public String toString() {
		return "TBL_SIF_ESTRUCTURA_DATOS_FTE [id_estructura=" + id_estructura + ", id_fuente=" + id_fuente
				...
				+ fecha_creacion + ", fecha_mod=" + fecha_mod + ", comentarios=" + comentarios + "]";
	}

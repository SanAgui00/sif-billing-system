...
public class TBL_SIF_CAT_ESTILOS_CARTA {
	@Id
	...
	public TBL_SIF_CAT_ESTILOS_CARTA() {

	}

	public TBL_SIF_CAT_ESTILOS_CARTA(Integer id_estilo, String clave, String descripcion, Integer b_mostrar_facturas,
	...
	public String toString() {
		return "TBL_SIF_CAT_ESTILOS_CARTA [id_estilo=" + id_estilo + ", clave=" + clave + ", descripcion=" + descripcion

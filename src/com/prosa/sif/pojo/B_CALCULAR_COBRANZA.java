...
public class B_CALCULAR_COBRANZA {
	// FUENTE
	...
	public B_CALCULAR_COBRANZA() {
	}

	public B_CALCULAR_COBRANZA(Number id_fuente, String clave, String descripcion_evento, Number total_trans_leidas,
	...
	public String toString() {
		return "B_CALCULAR_COBRANZA [id_fuente=" + id_fuente + ", clave=" + clave + ", descripcion_evento="

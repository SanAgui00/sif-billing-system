...
# Descripcion General : Pojo para mapeo de TBL_SIF_CAT_EMPRESAS                #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TBL_SIF_CAT_EMPRESAS {
	@Id
	...
	public TBL_SIF_CAT_EMPRESAS() {

	}

	public TBL_SIF_CAT_EMPRESAS(Integer id_empresa, String clave_empresa, String razon_social, String curp, String rfc,
			...
			String certificado, String key, String regimen_fiscal, String lugar_expedicion, String version_cfdi_sat,
	...
	public String toString() {
		return "TBL_SIF_CAT_EMPRESAS [id_empresa=" + id_empresa + ", clave_empresa=" + clave_empresa + ", razon_social="

...
public class B_COBRANZA_DIARIA {
	...
	public B_COBRANZA_DIARIA() {

	}

	public B_COBRANZA_DIARIA(Date fECHA_DATOS, Number pRECIO, Number iMP_COBDIA, Number dESC_AJUSTE, Number aJUSTE,
			Number dESC_COBDIA, Number tOTAL_COBDIA, Number iVA_AJUSTE, Number iVA_COBDIA, Number sUBTOTAL_COBDIA,
			Number sUBTOTAL_AJUSTE, Number dESC_ADICIONAL, Number tRX_COBDIA, Number tOTAL_AJUSTE, Number iD_CLIENTE,
			Number iD_SERVICIOS, Number iD_NEGOCIO, Number iD_MONEDA, Number iD_PROCESO, Number iD_EMPRESA,
			Number tIPO_CAMBIO, String cLAVE_CLIENTE, String cLAVE_NEGOCIO, String cLAVE_EMPRESA, String cLAVE_PROCESO,
			String rAZON_SOCIAL, String cLAVE_SERVICIO, String dESCRIPCION_SERVICIO, String nOMBRE_MONEDA,
			String dESC_PROCESO, String dESCRIPCION_NEGOCIO, String nOMBRE_CLIENTE, BigDecimal tOTAL_TRX_COBDIA,
			BigDecimal tOTAL_IMP_COBDIA, BigDecimal tOTAL_IMP_AJUSTE, BigDecimal tOTAL_DESC_ESPECIAL,
			BigDecimal tOTAL_DESC_ADICIONAL) {
		super();
		...
		TOTAL_TRX_COBDIA = tOTAL_TRX_COBDIA;
		TOTAL_IMP_COBDIA = tOTAL_IMP_COBDIA;
		TOTAL_IMP_AJUSTE = tOTAL_IMP_AJUSTE;
		TOTAL_DESC_ESPECIAL = tOTAL_DESC_ESPECIAL;
	...
	public String toString() {
		return "B_COBRANZA_DIARIA [FECHA_DATOS=" + FECHA_DATOS + ", PRECIO=" + PRECIO + ", IMP_COBDIA=" + IMP_COBDIA
				+ ", DESC_AJUSTE=" + DESC_AJUSTE + ", AJUSTE=" + AJUSTE + ", DESC_COBDIA=" + DESC_COBDIA
				+ ", TOTAL_COBDIA=" + TOTAL_COBDIA + ", IVA_AJUSTE=" + IVA_AJUSTE + ", IVA_COBDIA=" + IVA_COBDIA
				+ ", SUBTOTAL_COBDIA=" + SUBTOTAL_COBDIA + ", SUBTOTAL_AJUSTE=" + SUBTOTAL_AJUSTE + ", DESC_ADICIONAL="
				+ DESC_ADICIONAL + ", TRX_COBDIA=" + TRX_COBDIA + ", TOTAL_AJUSTE=" + TOTAL_AJUSTE + ", ID_CLIENTE="
				+ ID_CLIENTE + ", ID_SERVICIOS=" + ID_SERVICIOS + ", ID_NEGOCIO=" + ID_NEGOCIO + ", ID_MONEDA="
				+ ID_MONEDA + ", ID_PROCESO=" + ID_PROCESO + ", ID_EMPRESA=" + ID_EMPRESA + ", TIPO_CAMBIO="
				+ TIPO_CAMBIO + ", CLAVE_CLIENTE=" + CLAVE_CLIENTE + ", CLAVE_NEGOCIO=" + CLAVE_NEGOCIO
				+ ", CLAVE_EMPRESA=" + CLAVE_EMPRESA + ", CLAVE_PROCESO=" + CLAVE_PROCESO + ", RAZON_SOCIAL="
				+ RAZON_SOCIAL + ", CLAVE_SERVICIO=" + CLAVE_SERVICIO + ", DESCRIPCION_SERVICIO=" + DESCRIPCION_SERVICIO
				+ ", NOMBRE_MONEDA=" + NOMBRE_MONEDA + ", DESC_PROCESO=" + DESC_PROCESO + ", DESCRIPCION_NEGOCIO="
				+ DESCRIPCION_NEGOCIO + ", NOMBRE_CLIENTE=" + NOMBRE_CLIENTE + ", TOTAL_TRX_COBDIA=" + TOTAL_TRX_COBDIA
				+ ", TOTAL_IMP_COBDIA=" + TOTAL_IMP_COBDIA + ", TOTAL_IMP_AJUSTE=" + TOTAL_IMP_AJUSTE
				+ ", TOTAL_DESC_ESPECIAL=" + TOTAL_DESC_ESPECIAL + ", TOTAL_DESC_ADICIONAL=" + TOTAL_DESC_ADICIONAL
				+ "]";
	}

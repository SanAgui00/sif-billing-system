...
public class B_TBL_SIF_RESUMEN_ADQ {
	...
	public B_TBL_SIF_RESUMEN_ADQ() {

	}

	public B_TBL_SIF_RESUMEN_ADQ(Number id_fuente, Date hora_inicio, Date hora_final, String descripcion_evento,
			Number total_trans_leidas, Number total_trans_conv, Number total_trans_nconv, String estatus,
			Date fecha_datos, Date fecha_base_contingencia, Date fecha_ajuste, String clave) {
		super();
	...
	public String toString() {
		return "B_TBL_SIF_RESUMEN_ADQ [id_fuente=" + id_fuente + ", hora_inicio=" + hora_inicio + ", hora_final="

...
# Descripcion General : Pojo para mapeo de TablaCatTipoCuentas                 #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TablaTipoCuenta {
	...
	public TablaTipoCuenta(Integer id_tipo_cuenta, String descripcion, String clave, String numero_cta_contable,
			String estatus, Date fecha_cre, Date fecha_mod, String usuario, String comentarios, Integer tipo_mov) {
		super();
	...
	public String toString() {
		return "TablaTipoCuenta [id_tipo_cuenta=" + id_tipo_cuenta + ", descripcion=" + descripcion + ", clave=" + clave
				+ ", numero_cta_contable=" + numero_cta_contable + ", estatus=" + estatus + ", fecha_cre=" + fecha_cre
				+ ", fecha_mod=" + fecha_mod + ", usuario=" + usuario + ", comentarios=" + comentarios + ", tipo_mov="
				+ tipo_mov + "]";
	}

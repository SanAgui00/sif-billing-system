...
public class TablaFuente {
	...
	public TablaFuente(Integer id_fuente, Integer id_fuente_base_clave_cli, String clave, String descripcion,
			String estatus, Date fecha_creacion, Date fecha_mod, String usuario, String comentarios) {
		super();
	...
	public Integer getId_fuente_base_clave_cli() {
		return id_fuente_base_clave_cli;
	}

	public void setId_fuente_base_clave_cli(Integer id_fuente_base_clave_cli) {
		this.id_fuente_base_clave_cli = id_fuente_base_clave_cli;
	}
	...
	public String toString() {
		return "TablaFuente [id_fuente=" + id_fuente + ", id_fuente_base_clave_cli=" + id_fuente_base_clave_cli

...
# Descripcion General : Pojo para mapeo de TablaFormasPagos                    #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TablaFormaPagos {
	...
	public TablaFormaPagos() {
	}

	public TablaFormaPagos(Integer id_forma_pago, String clave, String descripcion, String estatus, Date fecha_cre,
			Date fecha_mod, String usuario, String comentarios) {
		super();
	...
	public String toString() {
		return "TablaFormaPagos [id_forma_pago=" + id_forma_pago + ", clave=" + clave + ", descripcion=" + descripcion

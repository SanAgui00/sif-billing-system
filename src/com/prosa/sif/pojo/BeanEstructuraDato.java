...
# Proyecto/Procliente :                                      Fecha: 20/06/2018 #
# Descripcion General : 										               #
# Marca del cambio    : 									                   #
################################################################################
**/
...
public class BeanEstructuraDato {
	...
	public BeanEstructuraDato() {
	}

	public BeanEstructuraDato(Number id_estructura, Number id_fuente, String tabla_totales, String tabla_temporal,
			Number b_suspender_depuracion, Number b_no_hay_carga, String nombre_campo_cliente,
	...
	public String toString() {
		return "BeanEstructuraDato [id_estructura=" + id_estructura + ", id_fuente=" + id_fuente + ", tabla_totales="
				...
				+ ", comentarios=" + comentarios + ", clave=" + clave + "]";
	}

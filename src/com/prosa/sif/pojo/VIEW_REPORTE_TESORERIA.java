...
public class VIEW_REPORTE_TESORERIA {
	...
	public VIEW_REPORTE_TESORERIA() {

	}

	public VIEW_REPORTE_TESORERIA(Integer id_moneda, String interfase, Integer id_cliente, Integer id_negocio,
			Integer id_proceso, Integer id_empresa, Date fecha_datos_ini, Date fecha_datos_fin, String nombre_corto,
			String sistema_cobro, String folio_temporal, Date fecha_envio, Date fecha_cobro, Date fecha_cobro2,
			String estatus, Date fecha_referencia, String descripcion_cobros, BigDecimal importe_de_cargo,
			BigDecimal iva_de_cargo, BigDecimal total_de_cargo, BigDecimal importe_de_abono, BigDecimal iva_de_abono,
			BigDecimal total_de_abono, Integer id_vista, String razon_social) {
		super();

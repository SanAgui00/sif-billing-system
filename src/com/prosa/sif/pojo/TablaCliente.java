...
# Proyecto/Procliente :                                      Fecha: 04/06/2018 #
# Descripcion General : Pojo para mapeo de TablaClientes                       #
# Marca del cambio    : 									                   #
#------------------------------------------------------------------------------#
...
public class TablaCliente {
	...
	private Integer	b_cliente_consorcio;
	private Integer	b_cliente_nacional;
	private Integer	b_cliente_socio;
	...
	private String	rfc_entidad_emi;
	private String	nom_entidad_emi;
	private String	cuenta_bancaria;
	private Integer	id_cuenta_banco;

	public TablaCliente() {

	}

	public TablaCliente(Integer id_cliente, String clave_cliente, Integer id_grupo_vol, Integer id_domicilio,
			String nombre_corto, String razon_social, String rfc, String curp, BigDecimal fiid, BigDecimal pct_iva,
			String telefono_pric, Integer b_cliente_consorcio, Integer b_cliente_nacional, Integer b_cliente_socio,
			Integer b_incluir_rebate, String inf_addicional, String inf_addicional_1, String usuario, String estatus,
			Date fecha_mod, String comentarios, String clave_formapago_sat, String clave_residfiscal_sat,
			String numero_idfiscal_sat, String rfc_entidad_emi, String nom_entidad_emi, String cuenta_bancaria,
			Integer id_cuenta_banco) {
		super();
		...
		this.rfc_entidad_emi = rfc_entidad_emi;
		this.nom_entidad_emi = nom_entidad_emi;
	...
	public Integer getB_cliente_consorcio() {
		return b_cliente_consorcio;
	}

	public void setB_cliente_consorcio(Integer b_cliente_consorcio) {
		this.b_cliente_consorcio = b_cliente_consorcio;
	}

	public Integer getB_cliente_nacional() {
		return b_cliente_nacional;
	}

	public void setB_cliente_nacional(Integer b_cliente_nacional) {
		this.b_cliente_nacional = b_cliente_nacional;
	}

	public Integer getB_cliente_socio() {
		return b_cliente_socio;
	}

	public void setB_cliente_socio(Integer b_cliente_socio) {
		this.b_cliente_socio = b_cliente_socio;
	}
	...
	public String getRfc_entidad_emi() {
		return rfc_entidad_emi;
	}

	public void setRfc_entidad_emi(String rfc_entidad_emi) {
		this.rfc_entidad_emi = rfc_entidad_emi;
	}

	public String getNom_entidad_emi() {
		return nom_entidad_emi;
	}

	public void setNom_entidad_emi(String nom_entidad_emi) {
		this.nom_entidad_emi = nom_entidad_emi;
	}
	...
	public Integer getId_cuenta_banco() {
		return id_cuenta_banco;
	}

	public void setId_cuenta_banco(Integer id_cuenta_banco) {
		this.id_cuenta_banco = id_cuenta_banco;
	}

	@Override
	public String toString() {
		return "TablaCliente [id_cliente=" + id_cliente + ", clave_cliente=" + clave_cliente + ", id_grupo_vol="
				...
				+ numero_idfiscal_sat + ", rfc_entidad_emi=" + rfc_entidad_emi + ", nom_entidad_emi=" + nom_entidad_emi
				+ ", cuenta_bancaria=" + cuenta_bancaria + ", id_cuenta_banco=" + id_cuenta_banco + "]";
	}

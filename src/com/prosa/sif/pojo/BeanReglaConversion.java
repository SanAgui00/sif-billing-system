...
# Proyecto/Procliente :                                      Fecha: 11/09/2018 #
# Descripcion General : 										               #
# Marca del cambio    : 									                   #
################################################################################
**/
...
public class BeanReglaConversion {
	...
	public BeanReglaConversion() {

	}

	public BeanReglaConversion(Number regla_conv_id, Number servicio_id, Number id_fuente, String clave,
	...
	public String toString() {
		return "BeanReglaConversion [regla_conv_id=" + regla_conv_id + ", servicio_id=" + servicio_id + ", id_fuente="

...
public class VIEW_REPORTE_CUENTAS_ACT_2 {

	@Id
	private Integer id_vistas;
	...
	public VIEW_REPORTE_CUENTAS_ACT_2() {

	}

	public VIEW_REPORTE_CUENTAS_ACT_2(Integer id_vistas, Integer id_periodos, String nombre, String clave_cliente,
			String nombre_corto, BigDecimal trans_credito, BigDecimal trans_debito, BigDecimal total) {
		super();
	...
	public Integer getId_vistas() {
		return id_vistas;
	}

	public void setId_vistas(Integer id_vistas) {
		this.id_vistas = id_vistas;
	}
	...
	public String toString() {
		return "VIEW_REPORTE_CUENTAS_ACT_2 [id_vistas=" + id_vistas + ", id_periodos=" + id_periodos + ", nombre="
				+ nombre + ", clave_cliente=" + clave_cliente + ", nombre_corto=" + nombre_corto
				+ ", trans_credito=" + trans_credito + ", trans_debito=" + trans_debito + ", total="
				+ total + "]";
	}
